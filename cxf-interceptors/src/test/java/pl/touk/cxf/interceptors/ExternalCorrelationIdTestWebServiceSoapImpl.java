...
public class ExternalCorrelationIdTestWebServiceSoapImpl implements TestWebServiceSoap {
    ...
    public TestResponse test(
        ...
        response.setCorrelationId(MDC.get(TestExternalCorrelationIdProvider.CORRELATION_ID));
        return response;
    }
}
